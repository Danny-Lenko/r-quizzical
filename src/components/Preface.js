...
export default function Preface(props) {
    ...
    return(
        ...
        <section className="Preface">
            ...
            <svg className="preface__blob1" width="194" height="197" viewBox="0 0 194 197" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg className="preface__blob2" width="148" height="118" viewBox="0 0 148 118" fill="none" xmlns="http://www.w3.org/2000/svg">
